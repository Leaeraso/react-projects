...
import {} from '../store/users/slice.ts'

export function ListOfUsers() {
  return (
    <div className="border rounded-2xl m-4 px-2 py-6 border-gray-200 text-gray-800">
      ...
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="w-[150px] text-center">Id</TableHead>
